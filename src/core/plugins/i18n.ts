...
const messages = {
  ...
  fr: {
    ...
    conditions: "Modalités et conditions",
    confirmPassword: "Confirmer le mot de passe",
    lastName: "Nom",
    password: "Mot de passe",
    helpPassword: "Utilisez 8 caractères ou plus avec un mélange de lettres, de chiffres et de symboles.",
    continue: "Continuer",
    ...
    passwordForget: "Saisissez votre adresse électronique pour réinitialiser votre mot de passe.",
    passwordForgetTitle: "Mot de passe oublié ?",
    ...
    createdAccount: "Vous avez déjà un compte ?",
    connectHere: "Connectez-vous ici",
    activity: "Activité",
    documentation: "Documentation",
