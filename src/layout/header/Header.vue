<template>
    <!--begin::Header-->
    <div id="kt_header" style="" class="header align-items-stretch bg-white mt-2 mb-10 shadow">
        <!--begin::Container-->
        <div :class="{
            ...
            <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
                <a href="#" class="d-lg-none">
                    <img alt="Logo" src="media/logos/logo-to-meet-rdv-basic.svg" class="h-30px" width="200" />
                </a>
            </div>
            <!--end::Mobile logo-->
