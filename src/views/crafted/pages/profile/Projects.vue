...
export default defineComponent({
  ...
  setup() {
    ...
    const users1 = [
      { name: "Emma Smith", src: "media/avatars/300-1.jpg" },
    ...
    const users3 = [
      { name: "Mad Masy", src: "media/avatars/300-1.jpg" },
    ...
    const users5 = [
      { name: "Francis Mitcham", src: "media/avatars/300-1.jpg" },
    ...
    const users7 = [
      { name: "Meloday Macy", src: "media/avatars/300-1.jpg" },
